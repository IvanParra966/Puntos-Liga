    ...
    <>
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        <div className="w-full max-w-md rounded-3xl border border-slate-800 bg-slate-950 p-6 shadow-2xl">
          <h3 className="text-xl font-semibold text-white">Eliminar torneo</h3>

          <p className="mt-2 text-sm text-slate-400">
            Vas a eliminar el torneo{' '}
            <span className="font-semibold text-white">
              {tournamentName || 'sin nombre'}
            </span>.
          </p>

          <p className="mt-2 text-sm text-slate-500">
            Para continuar, confirmá con tu contraseña.
          </p>
