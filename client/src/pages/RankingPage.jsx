...
export default function RankingPage() {
  ...
  return (
    <section className="space-y-6">
      <div className="rounded-[28px] border border-slate-800 bg-[radialgradient(circle_at_top_left,_rgba(34,211,238,0.10),_transparent_30%),lineargradient(180deg,rgba(2,6,23,0.98),rgba(3,7,18,0.98))] p-5 sm:p-8">
